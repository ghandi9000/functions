...
### keep track of parameter estimates from different models
# function to retrieve starting parameters, returns as list of params
get.params <- function(sr, spec, ind.var, dep.var, currentmodel, newpars=NULL) {
    parfile <- paste0("~/Allometry/parameters.csv")
